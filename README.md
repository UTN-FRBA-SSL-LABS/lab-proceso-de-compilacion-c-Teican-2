...
> **R:Marca las lineas de l preprocesador, Proviende de C:\mingw\include\stdio.h.**
...
> **R:toman la variable global llamadas y la incrementan en 1 para contar una invocación de sumar. y despues suma a + b**
...
> **R:         U _factorial 00000132 T _imprimir_separador 00000000 B _llamadas 0000001a T _main          U _printf          U _puts 00000000 T _sumar**
...
> **R:Porque la define otro matemarico.0**
...
> **R:lo reemplazaria el prepocesador manualmente en cambio una funcion real hace verificaciones y chequeo de tipos y se queda en las etapas posteriores como compilacion, ensamblado y enlazado**
...
> **R:T indica codigo ejecutable y d indica dato**
